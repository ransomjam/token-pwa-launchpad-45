...
const RAW_DEMO_LISTINGS = [
  {
    ...
    priceXAF: 6500,
    images: ['/demo/charger-front.svg', '/demo/charger-side.svg'],
  ...
  },
  {
    ...
    priceXAF: 8900,
    images: ['/demo/earbuds-case.svg', '/demo/earbuds-lifestyle.svg'],
    etaDays: { min: 10, max: 14 },
    lane: { code: 'GZ-DLA-AIR', onTimePct: 0.93, medianDays: 12 },
  ...
  },
  {
    ...
    priceXAF: 5200,
    images: ['/demo/lipstick-trio.svg', '/demo/lipstick-swatches.svg'],
